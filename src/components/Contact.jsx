      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="card">
              <h4 className="font-bold mb-3">Let's Connect</h4>
              ...
              <div className="flex gap-4">
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-accent/30 flex items-center justify-center hover:bg-accent/50 transition-colors duration-300"
                >
